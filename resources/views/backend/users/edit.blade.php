@extends('layouts.master', ['activePage' => 'users', 'titlePage' => 'Edit User'])
                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $user->profile_photo) }}" alt="Current Profile Photo" width="100">
                                ...
                                @foreach ($roles as $roleName => $roleDisplayName)
                                    <div class="col-md-4 col-sm-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="role" value="{{ $roleName }}" id="role_{{ Str::slug($roleName) }}"
                                                {{ (Str::lower(old('role', $user->getRoleNames()->first() ?? '')) === Str::lower($roleName)) ? 'checked' : '' }} required>
