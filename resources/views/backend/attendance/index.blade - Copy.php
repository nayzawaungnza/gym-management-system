...
function exportAttendance() {
    ...
    // Get the current member ID from the route or use the selected filter
    const routeMemberId = '{{ request()->route("member") ?? 0 }}';
    const exportMemberId = memberId || routeMemberId;
    
    if (!exportMemberId || exportMemberId === '0') {
        alert('Please select a member to export attendance data');
        return;
    }
    
    const form = document.createElement('form');
    form.method = 'POST';
    form.action = `/admin/members/${exportMemberId}/export-attendance`;
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="filter_member">
