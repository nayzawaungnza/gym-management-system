...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="mb-0 text-muted">Add new equipment to the gym inventory</p>
        </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('backend.equipment.store') }}" method="POST" enctype="multipart/form-data" id="equipmentForm">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('maintenance_interval_days') is-invalid @enderror" 
                                       ...
                                       value="{{ old('maintenance_interval_days') }}" min="1" max="365">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" id="next_maintenance_date" readonly>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('specifications') is-invalid @enderror" 
                                      ...
                                      placeholder='{"weight": "100kg", "dimensions": "2m x 1m x 1.5m", "power": "220V"}'>{{ old('specifications') }}</textarea>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <h6 class="mt-3">Maintenance Intervals</h6>
                    <ul class="small">
                        <li><strong>Cardio Equipment:</strong> 30-90 days</li>
                        <li><strong>Strength Equipment:</strong> 90-180 days</li>
                        <li><strong>Free Weights:</strong> 180-365 days</li>
                    </ul>
                </div>
            </div>
        </div>
