...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Gym Management /</span> Create New Member
    </h4>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('members.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('membership_start_date') is-invalid @enderror" 
                                           id="membership_start_date" name="membership_start_date" value="{{ old('membership_start_date', date('Y-m-d')) }}" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('medical_conditions') is-invalid @enderror" 
                                               id="medical_conditions" name="medical_conditions" value="{{ old('medical_conditions') }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('fitness_goals') is-invalid @enderror" 
                                               id="fitness_goals" name="fitness_goals" value="{{ old('fitness_goals') }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('referral_source') is-invalid @enderror" 
                                               id="referral_source" name="referral_source" value="{{ old('referral_source') }}"
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary me-2">Create Member</button>
