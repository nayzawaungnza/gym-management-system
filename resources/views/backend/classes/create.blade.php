@extends('layouts.master', ['activePage' => 'classes', 'titlePage' => 'Create Class'])

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Gym Management /</span> Create New Class
    </h4>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('classes.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="datetime-local" class="form-control @error('schedule_day') is-invalid @enderror" 
                                       id="schedule_day" name="schedule_day" value="{{ old('schedule_day') }}" required>
                                @error('schedule_day')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary me-2">Create Class</button>
