@extends('layouts.master', ['activePage' => 'membershiptypes', 'titlePage' => 'Add Membership Type'])

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Membership Types /</span> Add New Membership Type
    </h4>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control @error('type_name') is-invalid @enderror" 
                                       id="type_name" name="type_name" value="{{ old('type_name') }}" required>
                                @error('type_name')
    ...
    <div class="form-check">
        ...
        <label class="form-check-label" for="is_active_false">
            Inactive
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary me-2">Create Membership Type</button>
