                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-3 mb-6">
                                <div class="flex items-center text-sm text-gray-600">
                                    ...
                                    {{ $class->schedule_day->format('l, M j') }}
                                </div>
                                <div class="flex items-center text-sm text-gray-600">
                ...
                @php
                    $defaultClasses = [
                        ...
                        [
                            ...
                            'description' => 'Flowing yoga sequences to improve flexibility and mindfulness.',
                            'room' => 'Yoga Studio'
                        ],
                        [
                        ...
                        [
                            ...
                            'days' => ['Tue', 'Thu', 'Sat'],
                            'category' => 'dance',
                            'description' => 'Fun dance fitness combining Latin rhythms with easy-to-follow moves.',
                            'room' => 'Dance Studio'
                        ],
                        [
                            'name' => 'Pilates Core',
                            ...
                            'days' => ['Mon', 'Wed', 'Fri'],
                            'category' => 'flexibility',
                            'description' => 'Core-focused Pilates to improve posture and stability.',
                            'room' => 'Pilates Studio'
                        ],
                        [
                            'name' => 'CrossFit',
                ...
                @foreach($defaultClasses as $class)
                    <div class="class-card bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1" data-category="{{ $class['category'] }}">
                        ...
                        <div class="relative h-48 bg-gradient-to-br from-blue-500 to-purple-600">
                            ...
                            <div class="absolute top-4 left-4">
                                <span class="px-3 py-1 text-xs font-medium rounded-full 
                                    {{ $class['difficulty'] === 'Low' ? 'bg-green-100 text-green-800' : 
                                       ($class['difficulty'] === 'Medium' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800') }}">
                                    {{ $class['difficulty'] }}
                                </span>
                            </div>
                            <div class="absolute top-4 right-4">
                            ...
                            <div class="absolute bottom-4 left-4 text-white">
                                ...
                                <p class="text-sm opacity-90">{{ $class['instructor'] }}</p>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-3 mb-6">
                                ...
                                <div class="flex items-center text-sm text-gray-600">
                                    <i data-lucide="users" class="h-4 w-4 mr-2 text-blue-600"></i>
                                    {{ $class['current'] }}/{{ $class['max'] }} enrolled
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                <div class="flex justify-between text-xs text-gray-600 mb-1">
                                    <span>Capacity</span>
                                    <span>{{ $class['max'] - $class['current'] }} spots left</span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    <div class="bg-blue-600 h-2 rounded-full transition-all duration-300" 
                                         style="width: {{ ($class['current'] / $class['max']) * 100 }}%"></div>
                                </div>
                            </div>
