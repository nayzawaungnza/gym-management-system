...
$('#subscribe-form').submit(function (e) {
        ...
        $.ajax({
            ...
            error: function (xhr) {
                ...
                messageBox.html(`<div class="alert alert-danger">${errorMsg}</div>`);
            },
            complete: function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.success) {
                messageBox.html(`<div class="alert alert-success">${response.message}</div>`).removeClass("hidden");
                ...
                messageBox.html(`<div class="alert alert-danger">${response.message}</div>`).removeClass("hidden");
        ...
        error: function (xhr) {
            let errorMsg = xhr.responseJSON && xhr.responseJSON.message ? xhr.responseJSON.message : "Something went wrong!";
            messageBox.html(`<div class="alert alert-danger">${errorMsg}</div>`).removeClass("hidden");
