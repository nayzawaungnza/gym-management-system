...
class UpdateUserRequest extends FormRequest
{
    ...
    {
        // Assuming the route parameter for the user is named 'user' (e.g., users/{user})
        $userId = $this->route('user')->id;

        return [
           'name' => 'required|string|max:255',
           'email' => 'required|string|email|max:255|unique:users,email,' . $userId, // Corrected route parameter
            'phone' => 'nullable|string|max:15|unique:users', // Changed from 'mobile', corrected route parameter
    ...
    public function messages()
    {
        return [
            ...
            'address.regex' => 'Address format is invalid.', // Added message for address regex
